 ...
 */
public class HiglyHessian2InputCompatible extends AbstractHessianInput implements Hessian2Constants {
    private static final Logger log = Logger.getLogger(HiglyHessian2InputCompatible.class.getName());
     ...
     */
    public HiglyHessian2InputCompatible(InputStream is) {
        _is = is;
    }
