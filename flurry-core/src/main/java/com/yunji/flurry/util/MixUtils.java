...
public class MixUtils {
    ...
    public static String getZkAddress() {
        String zkAddress = System.getenv(com.yunji.flurry.util.GateConstants.REGISTRY_URL_KEY.replace('.', '_'));
        if (zkAddress == null) {
            zkAddress = System.getProperty(com.yunji.flurry.util.GateConstants.REGISTRY_URL_KEY);
        }
        if (zkAddress == null) {
            zkAddress = com.yunji.flurry.util.GateConstants.DEFAULT_REGISTRY_URL;
