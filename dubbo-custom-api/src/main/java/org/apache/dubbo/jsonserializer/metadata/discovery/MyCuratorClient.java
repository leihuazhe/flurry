...
public class MyCuratorClient {
    ...
    private static String urls = "zookeeper://127.0.0.1:2181/com.alibaba.dubbo.registry.RegistryService?application=demo-provider&dubbo=2.0.2&interface=com.alibaba.dubbo.registry.RegistryService&pid=21149&qos.port=22222&timestamp=1563858591252";
...
//        myCuratorClient.subscribe("/dubbo/com.maple.dubbo.api.DemoService/providers");
