...
//
///**
// * @author Denim.leihz 2019-07-05 4:05 PM
// */
...
//     */
//    private final ObjectOutput oproto;
//
//
//    /**
//     * 当前处理数据节点
...
//
//
//    JsonReader(ObjectOutput oproto) {
//        this.oproto = oproto;
//    }
//
//
//    @Override
//    public void onStartObject() throws JException {
//        level++;
//
...
//
//    @Override
//    public void onEndObject() throws JException {
//        level--;
...
//     */
//    @Override
//    public void onStartArray() throws JException {
//        level++;
//        if (skip) {
//            skipDepth++;
//            return;
...
//
//    @Override
//    public void onEndArray() throws JException {
//        level--;
//        if (skip) {
//            skipDepth--;
//            return;
...
//
//    @Override
//    public void onStartField(String name) throws JException {
//        if (skip) {
//            return;
//        }
...
//                        name);
//            } else {
//                logAndThrowJException("field " + name + " type " + toString(current.dataType) + " not compatible with json object");
//            }
//        }
//    }
//
...
//
//    @Override
//    public void onEndField() throws JException {
//        if (skip) {
...
//                case LIST:
//                    if (current.isNull) {
//                        logAndThrowJException("SET/LIST can't support null value");
//                    }
//                    break;
//                case MAP:
//                    if (current.isNull) {
...
//
//    @Override
//    public void onBoolean(boolean value) throws JException {
//        if (skip) {
//            return;
//        }
//
...
//
//    @Override
//    public void onNumber(double value) throws JException {
...
//                break;
//            default:
//                throw new JException("Field:" + current.fieldName + ", DataType(" + current.dataType.kind
...
//
//    @Override
//    public void onNumber(long value) throws JException {
//        throw new NotImplementedException();
//    }
//
//    @Override
//    public void onNull() throws JException {
//        if (skip) {
//            return;
//        }
//        current.isNull = true;
...
//
//    @Override
//    public void onString(String value) throws JException {
//        if (skip) {
//            return;
//        }
//
...
//                    throw new JException("Field:" + current.fieldName + ", Not a real String!");
//                }
//                oproto.writeString(value);
//        }
//    }
...
//    }
//
//    private void validateStruct(StackNode current) throws JException {
//        /**
...
//    }
//
//    private void writeIntField(String value, DataType.KIND kind) throws JException {
//        switch (kind) {
//            case SHORT:
//                oproto.writeI16(Short.parseShort(value));
//                break;
...
//     */
//    private void reWriteByteBuf() throws JException {
...
//    }
//
//    private void writeMapBegin(byte keyType, byte valueType, int defaultSize) throws JException {
...
//    }
//
//    private void reWriteMapBegin(byte keyType, byte valueType, int size) throws JException {
//        switch (invocationCtx.codecProtocol()) {
//            case Binary:
...
//     * @throws JException
//     */
//    private void writeCollectionBegin(byte valueType, int defaultSize) throws JException {
//        switch (invocationCtx.codecProtocol()) {
//            case Binary:
...
//    }
//
//    private void reWriteCollectionBegin(byte valueType, int size) throws JException {
//        switch (invocationCtx.codecProtocol()) {
//            case Binary:
...
//
//
//    private void logAndThrowJException() throws JException {
...
//        JException ex = new JException("JsonError, please check:"
//                + struct + "." + fieldName);
//        logger.error(ex.getMessage(), ex);
//        throw ex;
//    }
//
//    private void logAndThrowJException(String msg) throws JException {
//        JException ex = new JException("JsonError:" + msg);
//        logger.error(ex.getMessage(), ex);
//        throw ex;
//    }
//
