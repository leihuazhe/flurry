 ...
 */
public abstract class AbstractCustomHessian2Input extends AbstractHessianInput
        implements Hessian2Constants {

    private static final Logger log = Logger.getLogger(AbstractCustomHessian2Input.class.getName());
    ...
    protected Reader _chunkReader;
    protected InputStream _chunkInputStream;
    protected Throwable _replyFault;
     ...
     */
    public AbstractCustomHessian2Input(InputStream is) {
        _is = is;
    }
    ...
    //todo remove method  public Object readObject(List<Class<?>> expectedTypes) throws IOException;
