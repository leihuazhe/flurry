...
public class ZookeeperClientDiscovery extends AbstractZookeeperDiscovery implements Watcher {
        ...
        switch (event.getType()) {
            case NodeChildrenChanged:
                ...
                if (path.equals("/services")) {
                    LOGGER.info("/services 节点下的 children 发生变化,重新获取子节点");
    ...
    private void getDetailService(List<String> children) {
        ...
        LOGGER.info("/services has changed,re-add service list to root set, size {}", rootServices.size());
        ...
        for (String child : children) {
            ...
            String providerPath = "/services/" + child + "/" + RegistryConstants.PROVIDER;
...
//                metadataResolver.removeServiceByRoundInterface(serviceInterface);
            }
